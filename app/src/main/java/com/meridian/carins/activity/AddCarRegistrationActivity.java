...
public class AddCarRegistrationActivity extends Activity {
    ...
    public void init() {
        btnChoose = findViewById(R.id.choose_button_talon);
        btnUpload = findViewById(R.id.upload_button_talon);
        imagePreview = findViewById(R.id.imagePreviewTalon);
    }
